...
- Give one example of an AI suggestion that was incorrect or misleading (including what the AI suggested and how you verified the result).
  * The Suggestion: In one instance, I was analyzing Defect 3 (Attempt Counter) and Defect 4 (Difficulty Scaling) in two parallel chat sessions. When I prompted the AI to address the desynchronized counter, it provided a fix that successfully addressed the difficulty scaling (Defect 4) but completely ignored the "off-by-one" logic for the counter itself.
  * Verification: I verified the result by running the refactored code and observing the game window. While the "Normal" mode now correctly had more attempts than "Easy," the counter still started at 7 instead of 8 and remained "sticky" on the first guess. This highlighted the importance of keeping context together rather than splitting related logic into separate parallel sessions.
